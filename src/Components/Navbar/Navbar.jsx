    ...
    return (
        <div className="flex w-full items-start justify-center flex-col space-y-4 m-5">
            ...
            <ul className="max-w-[10rem] flex items-center justify-around gap-2 w-full">
                {headerLinks.map((link)=>(<Link to={link} className={cn(`decoration-0 flex max-w-[5rem] items-center justify-center w-full space-x-1  rounded-2xl p-1 border border-solid bg-text-sky-600`,{
